...
// Update Biometric UI - FIX DUPLICATE TEXT
...
// Enable Biometric - FETCH INSIDE CLICK FOR FRESH CHALLENGE
async function enableBiometric() {
  ...
  try {
    // Fresh fetch every time - avoids expired challenge
